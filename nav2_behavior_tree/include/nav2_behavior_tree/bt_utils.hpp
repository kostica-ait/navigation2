...
/**
 * @brief Parse XML string to std::vector<nav2_msgs::msg::WaypointStatus>
 * @param key XML string
 * @return std::vector<nav2_msgs::msg::WaypointStatus>
 */
template<>
inline std::vector<nav2_msgs::msg::WaypointStatus> convertFromString(
